...
type ClusterPair interface {
	...
	GetPair(*api.GetClusterPairRequest) (*api.GetClusterPairResponse, error)
	...
	// GeneratePairToken generates an authentication token
	GeneratePairToken(*api.GenerateClusterPairTokenRequest) (*api.GenerateClusterPairTokenResponse, error)

	// GetPairToken gets the authentication token for this cluster.
	GetPairToken() (*api.GetClusterPairTokenResponse, error)
}
