...
const (
	...
	// ClusterPairDefaultKey is the key at which the id for the default key is stored
...
func (c *ClusterManager) GetPairToken() (*api.GetClusterPairTokenResponse, error) {
	kvdb := kvdb.Instance()
...
func (c *ClusterManager) GeneratePairToken(
...
func pairDelete(id string) error {
	...
	if err != kvdb.ErrNotFound && defaultId == id {
		return fmt.Errorf("Cannot delete default pair")
	}
